            ...
            <div class="col-md-12 px-3">
                ...
                <div class="col-md-12 py-2">
                    ...
                    <div class="position-relative">
                        ...
                        <i class="bi bi-eye position-absolute" id="togglePassword1"
                ...
                <div class="col-md-12 py-2">
                    ...
                    <div class="position-relative">
                        ...
                        <i class="bi bi-eye position-absolute" id="togglePassword2"
                            style="right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer;"></i>
                    </div>
                </div>
                <div class="col-6 px-3 py-3" style="margin-left: 150px">
                    ...
                    <script>
                        ...
                        $(document).on('click', '#togglePassword2', function() {
                            let password = $('#inputConfirmPassword4');
