        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
            <div class="page-heading">
                ...
                <div class="heading-actions">
                    <a class="btn btn-secondary " href="{{ route('manager.employee-list') }}">
            ...
            <div class="page-body">
                <section class="row g-3">
                    <div class="col-12 col-xl-8">
                        <form class="panel needs-validation" action="{{ route('admin.update.employee', $user->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="gender" id="registerGender" class="form-control" required>
                                        ...
                                        <option value="O" @if ($user->gender == 'O') selected @endif>Others
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="role_id" id="role" required>
                                        ...
                                        <option value="2" @if ($user->role_id == '2') selected @endif>Manager
                                        </option>
                                        <option value="3" @if ($user->role_id == '3') selected @endif>Employee
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6"><label class="form-label" for="team">Team</label>
                                    <select class="form-select" id="team" name="team_id" required>
                                        ...
                                        @foreach ($teams as $singleteam)
                                            <option value="{{ $singleteam->id }}"
                                                @if ($user->team_id == $singleteam->id) selected @endif>
                                                {{ $singleteam->team_name }}</option>
                                        @endforeach
                                    </select>
